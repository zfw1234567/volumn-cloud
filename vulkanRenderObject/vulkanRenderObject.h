...
public:
    StageObject object;
    vulkanRenderObject(VkDevice device, VkPhysicalDevice physicalDevice, VkExtent2D swapChainExtent, VkCommandPool commandPool,VkQueue graphicsQueue);
    ~vulkanRenderObject();
    void createStageRenderResource (const std::string &objfile, const std::vector<std::string> &pngfiles, const VkDescriptorSetLayout &descriptorSetLayout,const vulkanUniformBuffer &meshUniformBuffer, const vulkanUniformBuffer &viewUniformBuffer,const vulkancubemaperesource &cubemap);
